...
class SQLAssignmentHandler(BaseAssignmentHandler):
    ...
    def execute_assignment(self, entity_id: int, assignment: 'AssignmentOperation') -> bool:
        """
        Execute a SQL assignment operation.
        ...
        try:
            ...
            if sql_statement.upper().startswith('SELECT'):
                return self._execute_select(entity_id, assignment, sql_statement)
            else:
                return self._execute_update(entity_id, assignment, sql_statement)
    ...
    def _execute_select(self, entity_id: int, assignment: 'AssignmentOperation', sql_statement: str) -> bool:
        """
            ...
            with self.engine.connect() as connection:
                ...
                try:
                    ...
                    if value is not None:
                        ...
                        success = self.entity_attribute_manager.set_attribute(entity_id, assignment.attribute_name, value)
                        self.logger.info(f"Entity {entity_id}: set_attribute({assignment.attribute_name}, {value}) returned: {success}")
    ...
    def _execute_update(self, entity_id: int, assignment: 'AssignmentOperation', sql_statement: str) -> bool:
        """
